...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">{{$filiere->Nom}}</h2>
            </div>
        ...
        <div class="mt-8 bg-white rounded">
            <div class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <span class="block text-gray-600 font-bold">{{ $filiere->Nom }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $filiere->code }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $filiere->description }}</span>
                    </div>
                </div>
                    ...
                    @foreach ($activities as $activity)
                        <div class="flex items-center justify-between border border-gray-200 mb-px">
                            ...
                            <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-medium">
                                <a href="{{ route('activity.show',$activity->id) }}" class="ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm" title="assign subject">
