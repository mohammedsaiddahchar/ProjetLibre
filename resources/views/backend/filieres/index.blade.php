    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('filieres.create') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            ...
            @foreach ($filieres as $filiere)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $filiere->code }}</div>
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <form action="{{ route('filieres.destroy',$filiere->id) }}" method="POST" class="inline-flex ml-1">
                            @csrf
                            @method('DELETE')
